...
def load_saved_artifacts():
    ...
    with open("C:\\Users\\ANANYA\\OneDrive\\Desktop\\BHP\\server\\artifacts\\columns.json", "r") as f:
        __data_columns = json.load(f)['data_columns']
        __locations = __data_columns[3:]  # first 3 columns are sqft, bath, bhk

    global __model
    if __model is None:
        with open("C:\\Users\\ANANYA\\OneDrive\\Desktop\\BHP\\server\\artifacts\\banglore_home_prices_model.pickle", 'rb') as f:
